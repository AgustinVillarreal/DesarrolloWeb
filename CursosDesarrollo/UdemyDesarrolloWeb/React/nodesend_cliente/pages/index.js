      ...
      <div className="md:w-4/5 xl:w-3/5 mx-auto mb-32">
        {url ? (
          <>
            ...
            <button
              type="button"
              className="bg-red-500 hover:bg-gray-900 hover:translate w-full p-2 text-white uppercase font-bold mt-10"
              onClick= {() => {
          ...
          <>
            ...
            <div className="lg:flex md:shadow-lg p-5 py-10 bg-white rounded-lg">
              <Dropzone />
